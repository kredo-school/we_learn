    ...
    <div class="h-screen w-screen bg-[url('/assets/images/student_pc_bk.jpg')] bg-center bg-no-repeat">
        ...
        <div class="h-screen flex justify-center items-center">
            <div class="flex flex-row">
                ...
                <a href="{{ route('learner.payment', ['ticket' => 10]) }}">
                    <div id="1-ticket" class="h-[250px] w-[250px] bg-white bg-cover bg-center rounded-lg group mx-10">
                        <div
                            class="h-full w-full hover:bg-[#000000]/70 rounded-lg flex flex-col justify-center items-center">
                ...
                <a href="{{ route('learner.payment', ['ticket' => 40]) }}">
                ...
                <a href="{{ route('learner.payment', ['ticket' => 70]) }}">
