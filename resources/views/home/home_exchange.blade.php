...
<div class="ml-10 mt-5 flex flex-col items-center">
    <div class="text-lg font-bold mb-2">The category is</div>
    <div class="w-[400px]">
...
<div class="ml-5 mt-15 flex justify-center w-screen mt-20">
    ...
    {{--  textbox for what I want to know  --}}
    <form>
        <div class="w-[600px] mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                ...
                <textarea id="comment" rows="4" class="w-full px-0 text-m font-bold text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" required>What I want to know:</textarea>
            </div>
            {{--  post button  --}}
    ...
    {{--  textbox for what I can teach  --}}
    <form>
        <div class="w-[600px] mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 ml-5">
            <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                <label for="comment" class="sr-only"></label>
                <textarea id="comment" rows="4" class="w-full px-0 text-m font-bold text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" required>What I Can Teach:</textarea>
            </div>
            {{--  post button  --}}
            <div class="grid justify-items-end px-3 py-2 border-t dark:border-gray-600">
                <div class="my-1 ">
