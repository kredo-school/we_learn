...
@section('contents')
    ...
    {{--  modal for cancel --}}
    <div id="cancel-lesson" tabindex="-1"
        ...
        <div class="relative w-full max-w-[800px] max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure to <span
                            class="text-red-400">cancel</span> this lesson?</h3>
