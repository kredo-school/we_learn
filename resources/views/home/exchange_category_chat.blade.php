...
<div class="h-screen w-screen bg-[url('../assets/images/bg_exchange-modified.jpg')] bg-center bg-no-repeat flex flex-col items-center justify-center">
    <div class="bg-gray-100 w-[1200px] flex flex-col items-center justify-center rounded-lg">
        ...
        <div class="ml-10 flex flex-col items-center">
            <div class="text-xl font-bold mb-2 mt-10 underline">The category is</div>
            <div class="w-[400px]">
        ...
        {{--  chat  --}}
        <div class="relative flex items-center justify-center antialiased bg-white bg-gray-100 min-w-screen mt-10 mb-20">
                ...
                <div
                    ...
                    <div class="flex flex-row">
                        ...
                        <div class="flex-col mt-1">
                            ...
                            {{--  respond button  --}}
                            <button onclick="show()" id="show-form-btn" class="inline-flex items-center px-1 pt-2 ml-1 flex-column">
