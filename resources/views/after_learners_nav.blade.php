      ...
      <div class="relative relative-hover">
        <div class="flex items-center">
            <button class="text-sm text-black hover:text-[#ED4C59] px-4 py-2">
              <img src="{{ ($learner->profile_img != null) ? $learner->profile_img : '/assets/images/user-circle.png' }}" alt="User-pic" class="w-7 h-7 object-cover rounded-full" />
            </button>
        ...
        <div class="absolute z-10 hidden bg-white rounded-lg shadow-md">
          <a href="{{ route('learner.show.profile',['id' => $learner->id])}}" class="block px-4 py-2 text-gray-800 hover:bg-gray-200 flex items-center">
            <img src="{{ ($learner->profile_img != null) ? $learner->profile_img : '/assets/images/user-circle.png' }}" alt="User-pic" class="w-4 h-4 object-cover rounded-full mr-2" />
