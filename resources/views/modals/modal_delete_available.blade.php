<div id="delete-available-{{ $key }}" tabindex="-1"
    ...
    <div class="relative w-full max-w-[800px] max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                ...
                data-modal-hide="delete-available-{{ $key }}">
            ...
            <div class="p-6 text-center">
                        ...
                        <tbody>
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                <th scope="row"
                                    ...
                                    <img class="w-10 h-10 rounded-full" src="{{($teacher->profile_img != null) ? $teacher->profile_img : url('/assets/images/insert-photo.jpg')}}"
                                        alt="image">
                                    <div class="pl-3">
                ...
                {{--  button for yes  --}}
                <form action="{{ route('teacher.delete.schedule', ['reservation' => $reservation->id]) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <a href="#">
