                    ...
                    <div class="flex flex-wrap justify-center items-center w-full">
                        <div class="w-full flex justify-center">
                            <div class="relative flex justify-center items-center w-full">
                                <div
                                    class="bg-[url('/assets/images/pexels-andrea-piacquadio-3776178.jpg')] shadow-xl rounded-full h-[150px] w-[150px] align-middle border-none absolute -m-16 -ml-20 bg-center bg-cover bg-no-repeat">
                                </div>
                            </div>
                        </div>
                        {{-- button --}}
