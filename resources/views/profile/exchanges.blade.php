                ...
                <div class="px-6">
                    <div class="flex flex-wrap justify-center">
                        ...
                        <div class="flex items-end justify-end w-full py-10">
                            <button onclick="location.href='{{ route('exchange.edit.profile', ['id' => $exchange->id])}}'"
                    ...
                    <div class="text-center flex flex-col justify-center items-center">
                        ...
                        <div class="text-sm leading-normal mt-0 mb-2 text-blueGray-400 font-bold">
                            ...
                            Regidence/Country :
                            <span class="mb-2 text-blueGray-600">{{ $exchange->residence }}</span>
                        </div>
                        {{-- Age --}}
                        <div class="text-sm leading-normal mt-0 mb-2 text-blueGray-400 font-bold">
                            <i class="fa-solid fa-hourglass-half mr-2 text-lg text-blueGray-400"></i>
                            Age :
                            <span class="mb-2 text-blueGray-600">{{ $exchange->age }}</span>
                        </div>
                        {{-- Gender --}}
                        <div class="text-sm leading-normal mt-0 mb-2 text-blueGray-400 font-bold">
                            <i class="fa-solid fa-restroom mr-2 text-lg text-blueGray-400"></i>
                            Gender :
                            <span class="mb-2 text-blueGray-600">{{ $exchange->gender }}</span>
                        </div>
                        {{-- Occupation --}}
                        <div class="text-sm leading-normal mt-0 mb-2 text-blueGray-400 font-bold">
                            <i class="fas fa-briefcase mr-2 text-lg text-blueGray-400"></i>
                            Occupation :
                            <span class="mb-2 text-blueGray-600">{{ $exchange->occupation }}</span>
                        </div>
                        {{-- Category --}}
                        <div class="text-sm leading-normal mt-0 mb-2 text-blueGray-400 font-bold">
                            <i class="fa-solid fa-microphone mr-2 text-lg text-blueGray-400"></i>
                            Category :
                            <span class="mb-2 text-blueGray-600">{{ $exchange->category }}</span>
                        </div>
                        {{-- About me  --}}
                        <div class="text-sm leading-normal mt-0 mb-2 text-blueGray-400 font-bold mb-2">
                            <i class="fa-solid fa-face-smile mr-2 text-lg text-blueGray-400"></i>
                            About me :
                            <span class="mb-2 text-blueGray-600">{{ $exchange->about }}</span>
                        </div>
                    </div>
                </div>
            </div>
